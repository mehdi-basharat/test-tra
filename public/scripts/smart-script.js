  ...
  if (null != o) {
    ...
    try {
      if (((n = (o = o.call(t)).next), 0 === e)) {
        ...
        l = !1;
      } else for (; !(l = (r = n.call(o)).done) && (s.push(r.value), s.length !== e); l = !0);
    } catch (t) {
      (u = !0), (i = t);
    } finally {
      try {
...
function aggregateValuesFromParameters() {
  var e = [];
  return (
    Object.values(0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}).forEach(function (t) {
      t &&
        t.keys &&
...
var isOneLinkURLValid = function (t) {
  ...
  validatedMs = function () {
    ...
    return (
      !!(0 !== (null == e || null == (t = e.keys) ? void 0 : t.length) || (null != e && e.defaultValue)) ||
  ...
  isSkipListsValid = function (t) {
    ...
    return (
      ...
      }) && !isSkippedURL({ url: document.URL, skipKeys: t, errorMsg: 'Generate url is skipped. URL contains string:' })
    );
  },
...
function QRCode() {
  ...
  for (
    var s = { MODE_NUMBER: 1, MODE_ALPHA_NUM: 2, MODE_8BIT_BYTE: 4, MODE_KANJI: 8 },
      ...
      v = {
        ...
        getErrorCorrectPolynomial: function (t) {
          for (var e = new S([1], 0), o = 0; o < t; o++) e = e.multiply(new S([1, y.gexp(o)], 0));
          return e;
        },
    ...
    y.EXP_TABLE[b] = 1 << b;
  for (b = 8; b < 256; b++)
    y.EXP_TABLE[b] = y.EXP_TABLE[b - 4] ^ y.EXP_TABLE[b - 5] ^ y.EXP_TABLE[b - 6] ^ y.EXP_TABLE[b - 8];
                      ...
                      l
                        ? ((d = 'AO' == l.type ? c.dotScaleAO : 'AI' == l.type ? c.dotScaleAI : 1),
                          c.backgroundImage && c.autoColor
                            ? ((r = ('AO' == l.type ? c.AI : c.AO) || c.autoColorDark), (i = c.autoColorLight))
                      ...
                      (u.onload = function () {
                        ...
                        (t = u),
                          ...
                          (c.logoMaxWidth || c.logoMaxHeight) &&
                            (c.logoMaxWidth && a <= e && (e = a), c.logoMaxHeight && s <= o && (o = s), a <= e) &&
                            s <= o &&
                            ((e = a), (o = s)),
    ...
    generateOneLinkURL: function () {
      ...
      return isOneLinkURLValid(e) &&
        ...
        ? ((o = _objectSpread2({ af_js_web: !0, af_ss_ver: window.AF_SMART_SCRIPT.version }, n)),
          ...
          (i = updateFinalUrlWithForwardParameters(i, [GOOGLE_CLICK_ID, FACEBOOK_CLICK_ID], window.location.search)),
          getParameterValueFromURL(window.location.search, GOOGLE_CLICK_ID) &&
            ((n = getParameterValueFromURL(window.location.search, ASSOCIATED_AD_KEYWORD)),
            (e = getParameterValueFromURL(i, AF_KEYWORDS)),
            n) &&
            !e &&
            (i = ''.concat(i, '&').concat(AF_KEYWORDS, '=').concat(n)),
              ...
              ? ((n = null == n ? void 0 : n.toLowerCase()),
                isPlatformValid(n)
                  ? 'string' != typeof a
                    ...
                    : 0 !== (null == o || null == (t = o.keys) ? void 0 : t.length) || (null != o && o.defaultValue)
                      ? isSkipListsValid({ referrerSkipList: r, urlSkipList: i }) &&
                        ...
                        ? ((i = _objectSpread2({ af_js_web: !0, af_ss_ver: window.AF_SMART_SCRIPT.version }, r)),
...
var oneLinkURL = 'https://tyrrewards.onelink.me/UyjW';
var webReferrer = 'af_channel';
var mediaSource = { keys: ['utm_source'], defaultValue: 'website' };
var campaign = { keys: ['utm_campaign'] };
var adSet = { keys: ['utm_medium'] };
var af_siteId = { paramKey: 'af_siteId', keys: ['utm_content'] };
var af_c_id = { paramKey: 'af_c_id', keys: ['utm_id'] };
...
var result = window.AF_SMART_SCRIPT.generateOneLinkURL({
  ...
  afParameters: {
    ...
    campaign: campaign,
    adSet: adSet,
    afCustom: [af_siteId, af_c_id, af_keywords, custom_ss_ui],
